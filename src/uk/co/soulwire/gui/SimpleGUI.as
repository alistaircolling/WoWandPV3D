...
package uk.co.soulwire.gui {
	...
	public class SimpleGUI extends EventDispatcher {
		...
		public function addLabel(text : String) : Label {
			var labl : * = addControl(Label, {text:text.toUpperCase()});
			return labl;
		}
...
//NASTY HACK BELOW -1 !!!!!! FIXME is there cos i added a text field to the gui
			for (i = 0; i < _container.numChildren-1; i++) {
